...
router.post('/updateverifikasipatensave', checkAuth, function (req, res, next) {
  ...
  let validate = Joi.object().keys({
    // judul: Joi.string().required(),
    nomor_permohonan: Joi.string(),
    pemeriksa_paten: Joi.string(),
    kontak_pemeriksa: Joi.string(),
    email_pemeriksa: Joi.string(),
    sertifikasi: Joi.string(),
    filling: Joi.string(),
    formalitas: Joi.string(),
    publish: Joi.string(),
    pembayaran: Joi.string(),
    pemberian: Joi.string(),
    jumlah_klaim: Joi.string(),
    nomor_paten: Joi.string(),
    tahun_granted: Joi.string(),
    status: Joi.number(),
    tindak_lanjut: Joi.number(),
